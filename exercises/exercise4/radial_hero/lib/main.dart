...
class RadialExpansionDemo extends StatelessWidget {
  ...
  static double kMinRadius = 30.0;
  static double kMaxRadius = 130.0;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'images/flower.jpg', 'flower'),
            _buildHero(context, 'images/tree.jpg', 'tree'),
            _buildHero(context, 'images/cat.jpg', 'cat'),
          ],
        ),
      ),
    );
